...
| 姓名 | 学号 | 分工内容 |
| ------------ | ------------ | ------------ |
| 黄子弋 | 20033077 | 项目实施UI系统，怪物路径等、文档功能点编写、ppt架构制作 |
| 黄琛学 | 20031104 | 项目实施动画系统，数据保存与加载等、文档游戏介绍编写、ppt内容制作 |
| 黎怡至 | 20032027 | 项目实施炮台创建，升级和拆除等、文档知识点编写、ppt大纲制作 |
| 陈庭轩 | 20031095 | 项目实施物理系统等、视频录制、ppt模板制作 |
